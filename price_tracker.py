...
Info  : https://brightdata.de/products/insights/price-tracker/ricardo
"""
...
# https://brightdata.de/products/web-scraper/ricardo
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Ricardo scraper at: https://brightdata.de/products/web-scraper/ricardo\n"
